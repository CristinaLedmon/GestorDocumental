...
export function ChartAreaInteractive(props: ChartProps) {
  const chartConfig = {
    superficie: {
      label: `Superficie (${getUnit(props.type)})`,
      color: "var(--chart-1)"
    },
    fondo: {
      label: `Fondo (${getUnit(props.type)})`,
      color: "var(--chart-2)"
    }
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        <ChartContainer config={chartConfig} className="aspect-auto h-[250px] w-full">
          <AreaChart data={filteredData}>
            <defs>
              <linearGradient id="fillSuperficie" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="var(--color-desktop)" stopOpacity={0.8} />
                <stop offset="95%" stopColor="var(--color-desktop)" stopOpacity={0.1} />
              </linearGradient>
              <linearGradient id="fillFondo" x1="0" y1="0" x2="0" y2="1">
